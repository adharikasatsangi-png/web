(async function() {
    ...
    let total_number_of_exams_taken = parseInt(prompt("Enter the total number of exams you already have grades available for:"), 10);
    ...
    if (average_percentage_needed > 100) {
        ...
        alert(`You need to score an average of ${average_percentage_needed.toFixed(2)}% on the remaining exams to achieve your desired grade.`);
    }
